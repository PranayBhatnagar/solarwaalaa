 ...
 * and /photo-credits) - placeholders until Solarwaalaa's own project
...
export const solutions: (Solution & { slug: string; bodyIntro: string; bestFor: string[] })[] = [
  {
    ...
    bodyIntro:
      "A home solar system is sized around your roof, your household's electricity usage, and how your local connection is set up. Solarwaalaa starts every residential enquiry with a site assessment rather than a generic package.",
  ...
  },
  {
    ...
    bodyIntro:
      "Educational campuses, healthcare facilities, government and community buildings each have their own approval processes, usage patterns and budget cycles. Solarwaalaa works through these alongside your facilities team.",
